          ...
          <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-blue-600 mb-1">📧 Email: <strong>admin@company.com</strong></p>
                <p className="text-xs text-blue-600 mb-2">🔑 Password: <strong>Admin@123</strong></p>
                <button
                  type="button"
